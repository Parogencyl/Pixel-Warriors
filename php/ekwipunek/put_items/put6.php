...
$selectSlotsBp = "SELECT backpack.slot1, backpack.slot2, backpack.slot3, backpack.slot4, backpack.slot5, backpack.slot6,
    ...
    if ($row['slot6'] == "../Przedmioty/Ramka_Gif.gif") {
        ...
        $updateEq = "UPDATE equipment INNER JOIN player ON player.Id=equipment.IdEquipment SET equipment.Slot6='$itemSlot' WHERE player.Login='$user_check'";
        ...
        $slotNumber = $number;
            ...
            MagicDefence='$mDefence', Improvment='$improvment', ItemId='$itemId', Price='$price' WHERE player.Login='$user_check' AND Slot='6'";
